...
def index_directory(doc_path: str,
                    embedding_type: str = "sentence-transformers/all-MiniLM-L6-v2",
                    chunk_size: int = 1000,
    ...
    :param embedding_type: Type of embedding to be used. Must be in HuggingFaceEmbeddings model_name(s)
    ...
    save_to_chroma(chunks, embedding_type=embedding_type, chroma_path=chroma_path, collection_name=collection_name)
